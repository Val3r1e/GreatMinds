...
def readData():
    ...
    json.dump(firstPubDict, open("first-published.json",'w'))
    json.dump(no_firstPub, open("missing-firstPubl.json", 'w'))
    json.dump(typesDict, open("types.json", 'w'))
    json.dump(yearsDict, open("years.json", 'w'))
    json.dump(no_year, open("no-years.json", 'w'))
    json.dump(bookTitleDict, open("booktitles.json", 'w'))
    json.dump(no_bookTitle, open("no-years.json", 'w'))
    json.dump(publisherDict, open("publisher.json", 'w'))
    json.dump(no_publisher, open("no-publisher.json", 'w'))
    json.dump(pagesDict, open("pages.json", 'w'))
    json.dump(no_pages, open("no-pages.json", 'w'))
