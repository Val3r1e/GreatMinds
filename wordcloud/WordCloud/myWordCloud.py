...
def readTxt(name):
    ...
    mask = np.array(Image.open(path.join(currdir, "shapes/1780.png")))     #for ex. exchange line for cloud
    ...
    wc = WordCloud(background_color="white",
                    #font_path="/System/Library/Fonts/HelveticaNeue.ddt",  #Add Path to Fonts on your Computer
                    max_words=200,
                    ...
                    colormap="Accent")          #Add different Colormap here, can be found here: https://matplotlib.org/users/colormaps.html
    
    wc.generate(text)

    wc.to_file(path.join(currdir, "Wordclouds/1780-colored4.png"))


readTxt("../txt/every_five_years/filtered/filtered_1780.txt")
