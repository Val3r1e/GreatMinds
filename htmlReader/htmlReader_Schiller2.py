...
'''eg: python3 htmlReader_Schiller2.py "../data/briefwechsel-zwischen-schiller-und-goethe-band-2" "../ignore/letters/Schiller2/html" '''
...
def write_metadata(soup,filename, direc, source):
    ...
    name = filename.replace("ignore/letters/Schiller2/html/","ignore/letters/Schiller2/meta/")
    metadata = {}
