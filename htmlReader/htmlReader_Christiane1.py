...
'''eg: python3 htmlReader_Christiane1.py "../data/briefwechsel-mit-seiner-frau-band-i" "../ignore/letters/Christiane1/html" '''
...
def write_metadata(soup,filename, direc, source):
    ...
    name = filename.replace("ignore/letters/Christiane1/html/","ignore/letters/Christiane1/meta/")
    metadata = {}
